...
public class ErrorCode {
	...
	public static final String USER_PARAM_ERROR = "400104"; // 参数错误
	...
	public static final String DEVICE_NOT_BELONG_TO_YOU = "403202"; //无权限操作此设备
	/******************************************
	 * 2 Device
	 ******************************************/
	...
	/** 没有权限 **/
	public static final String GROUP_NOT_BELONG_TO_YOU = "4001002";
	...
	public static final String VEHICLE_PARAMETER_ERROR = "4001110";
	public static final String VEHICLE_BIND_REPEAT = "4001111";
	/** 没有权限 **/
	public static final String DRIVER_NOT_BELONG_TO_YOU = "4001101";
	public static final String VEHICLE_NOT_BELONG_TO_YOU = "4001111";
	
	public static final String VEHICLE_NOT_DELETE_HAVE_DEVICE = "4001102";
	public static final String VEHICLE_NOT_CHANGEORGID_HAVE_DEVICE_DRIVER = "4001103";
	/** 请求的内容不存在 **/
	public static final String DRIVER_NOT_FOUND = "4041100";
	public static final String VEHICLE_NOT_FOUND = "4041110";
	 ...
	 ******************************************/
	/** 请求出现错误等 **/
	public static final String AREA_PARAMETER_ERROR = "4001200";
	/** 没有权限 **/
	
	/** 请求的内容不存在 **/
	public static final String AREA_NOT_FOUND = "4041200";
	...
	/** 没有权限 **/
	public static final String SHARE_OUT_OF_DATE = "4001301";
	/** 请求的内容不存在 **/
