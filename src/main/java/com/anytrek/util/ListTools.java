...
public class ListTools {
	...
	/**
	 *** Compares 2 boolean arrays, returning the index of the boolean where they
	 * differ
	 *** 
	 * @param a1
	 *            First boolean array
	 ...
	 *** @return The index/location where the boolean arrays differ, or -1 if they
	 *         are the same
	 **/
	...
	/**
	 *** Compares 2 character arrays, returning the index of the character where
	 * they differ
	 *** 
	 * @param a1
	 ...
	 *** @return The index/location where the character arrays differ, or -1 if
	 *         they are the same
	 **/
	 ...
	 *** @param a2
	 *            Second int array
	 *** @return The index/location where the int arrays differ, or -1 if they are
	 *         the same
	 **/
	 ...
	 *** @param a2
	 *            Second long array
	 *** @return The index/location where the long arrays differ, or -1 if they
	 *         are the same
	 **/
	...
	/**
	 *** Compares 2 double arrays, returning the index of the double where they
	 * differ
	 *** 
	 * @param a1
	 *            First double array
	 *** @param a2
	 *            Second double array
	 *** @return The index/location where the double arrays differ, or -1 if they
	 *         are the same
	 **/
	...
	/**
	 *** Compares 2 Object arrays, returning the index of the Object where they
	 * differ
	 *** 
	 * @param a1
	 *            First Object array
	 *** @param a2
	 *            Second Object array
	 *** @return The index/location where the Object arrays differ, or -1 if they
	 *         are the same
	 **/
	...
	/**
	 *** Returns the array item at the specified index, or the default value if
	 * the array has not such element
	 *** 
	 * @param c
	 *            The item <code>Collection</code>
	 *** @param ndx
	 *            The item index
	 *** @param dft
	 ...
	 *** 
	 * @param list
	 *            The List instance containing the specified element
	 *** @param item
	 *            The List element for which the index will be returned
	 *** @return The index of the specified element within the specified List, or
	 *         -1 if the specified element was not found in the specified List
	 **/
	...
	/**
	 *** Returns the index of the specified case-insensitive String value within
	 * the specified List.
	 *** 
	 * @param list
	 *            The List containing String values
	 *** @param item
	 *            The String value for which the index will be returned
	 *** @return The index of the specified case-insensitive String value within
	 *         the specified List, or -1 if the case-insensitive String value
	 *         was not found.
	 **/
	@SuppressWarnings("rawtypes")
	 ...
	 *** 
	 * @param list
	 *            The array containing String values
	 *** @param item
	 *            The String value for which the index will be returned
	 *** @return The index of the specified case-insensitive String value within
	 *         the specified array, or -1 if the case-insensitive String value
	 *         was not found.
	 **/
	 ...
	 *** 
	 * @param list
	 *            The array containing the specified object
	 *** @param item
	 *            The element for which the index will be returned
	 *** @return The index of the specified element within the specified array, or
	 *         -1 if the specified element was not found in the specified array
	 **/
	 ...
	 *            The array containing the specified object
	 *** @param ofs
	 *            The offset within the array to begin searching
	 *** @param len
	...
	public static <T> int indexOf(T list[], int ofs, int len, T item) {
		if (list == null) {
			...
			len = _constrainLength(ofs, len, alen); // len <= (alen - ofs), may
													// be '0'
	 ...
	 *** 
	 * @param list
	 *            The List instance to search
	 *** @param item
	 *            The element which is tested for inclusion in the specified
	 *            List
	 ...
	 *            The List instance to search
	 *** @param item
	 *            The case-insensitive String which is tested for inclusion in
	 *            the specified List
	 *** @return True if the List contains the specified case-insensitive String
	 *         value
	 **/
	...
	/**
	 *** Returns true if the specified array contains the specified
	 * case-insensitive String value
	 *** 
	 * @param list
	 *            The array instance to search
	 *** @param item
	 *            The element which is tested for inclusion in the specified
	 *            array
	...
	/**
	 *** Returns true if all elements of the specified list are subclasses of the
	 * specified Class
	 *** 
	 * @param list
	 *            The List to check
	 *** @param type
	 *            The Class object used to check against all elements in the
	 *            List
	 *** @return True if all elements in the List are subclasses of the specified
	 *         Class
	 **/
	 ...
	 *            The object array to copy to a List instance
	 *** @param list
	 *            The List instance to which the elements of the Object array
	 *            will be copied
	 *** @return The List instance containing the elements of the specified array
	 **/
	 ...
	 *            The object array to copy to a List instance
	 *** @param ofs
	 *            The offset within the specified Object array to begin copying
	 *            to list
	 *** @param len
	 *            The number of elements from the specified Object array to copy
	 *            to list
	 *** @param list
	 *            The List instance to which the elements of the object array
	 *            will be copied
	...
	public static <T> java.util.List<T> toList(T a[], int ofs, int len, java.util.List<T> list) {
		...
		ofs = _constrainOffset(ofs, alen); // ofs <= alen
		len = _constrainLength(ofs, len, alen); // len <= (alen - ofs), may be
												// '0'
		for (int i = ofs; i < (ofs + len); i++) {
			v.add(a[i]);
		}
	 ...
	 *            The Enumeration to copy to a List instance
	 *** @param list
	 *            The List instance to which the elements from the Enumeration
	 *            will be copied
	 *** @return The List instance containing the elements of the Enumeration
	 **/
	 ...
	 *            The Iterator to copy to a List instance
	 *** @param list
	 *            The List instance to which the elements from the Iterator will
	 *            be copied
	 *** @return The List instance containing the elements of the Iterator
	 **/
	 ...
	 *            The Set to copy to a List instance
	 *** @param list
	 *            The List instance to which the elements from the Set will be
	 *            copied
	 *** @return The List instance containing the elements of the Set
	 **/
	 ...
	 *            The StringTokenizer to copy to a List instance
	 *** @param list
	 *            The List instance to which the elements from the
	 *            StringTokenizer will be copied
	 *** @return The List instance containing the elements of the StringTokenizer
	 **/
	 ...
	 *            The List to copy to a new List instance
	 *** @param list
	 *            The List instance to which the elements from the specified
	 *            List will be copied
	 *** @return The List instance containing the elements of the specified List
	 **/
	...
	/**
	 *** Copies the specified Enumeration to a new array of the specified Class
	 * type
	 *** 
	 * @param e
	 *            The Enumeration to copy to the new array
	 *** @param type
	...
	/**
	 *** Copies the specified Collection to a new array of the specified Class
	 * type
	 *** 
	 * @param list
	 *            The Collection to copy to the new array
	...
	/**
	 *** Creates a new array containing a subset of the elements in the specified
	 * array
	 *** 
	 * @param arry
	 *            The array containing elements to be copied to a new array
	 *** @param ofs
	 *            The offset within <code>arry</code> to begin copying
	 *** @param len
	...
	public static <T> T[] toArray(T arry[], int ofs, int len) {
		if (arry != null) {
			...
			if (ofs < arry.length) { // len would be '0' if ofs==arry.length,
										// but dont even attempt
	...
	/**
	 *** Creates a new 'int' array containing the elements in the specified
	 * 'Integer' list
	 *** 
	 * @param list
	 *            The Collection to copy to the new array
	...
	/**
	 *** Creates a new 'long' array containing the elements in the specified
	 * 'Long' list
	 *** 
	 * @param list
	 *            The Collection to copy to the new array
	...
	/**
	 *** Creates a new 'double' array containing the elements in the specified
	 * 'Double' list
	 *** 
	 * @param list
	 *            The Collection to copy to the new array
	...
	/**
	 *** Returns a String array comprised of toString() calls to the specified
	 * Object array
	 *** 
	 * @param a
	 *            The Object array
	 ...
	 *** @return The Set (HashSet) containing the elements from the specified
	 *         array
	 **/
	 ...
	 *            The array to copy to the Set
	 *** @param ofs
	 *            The offset within 'a' to begin copying
	 *** @param len
	 *            The number of elements to copy to the new array
	 *** @param set
	 *            The Set to which the array elements will be copied
	 ...
	 *** 
	 * @param list
	 *            The List to which the specified object will be added
	 *** @param obj
	...
	/**
	 *** Creates a new array with the specified object appended to the end of the
	 * specified array
	 *** 
	 * @param list
	 *            The array to which the object will be appended
	 *** @param obj
	 *            The object to append to the specified array
	 *** @return The new Object array to which the specified object instance was
	 *         appended
	 **/
	...
	/**
	 *** Inserts the specified Object to the specified List, at the specified
	 * location
	 *** 
	 * @param list
	 *            The List to which the specified object will be inserted
	 *** @param obj
	 *            The Object to insert into the specified List
	 *** @param ndx
	 *            The location in the List instance where the object will be
	 *            inserted
	...
	/**
	 *** Creates a new array with the specified object inserted into specified
	 * array
	 *** 
	 * @param list
	 *            The array to which the object will be inserted
	 *** @param obj
	 *            The object to insert into the specified array
	 *** @param index
	 ...
	 *** 
	 * @param list
	 *            The List from which the element at the specified index will be
	 *            removed
	 *** @param ndx
	 ...
	 *            The Comparator used to sort the specified List
	 *** @param forwardOrder
	 *            True to sort based on the Comparator, false to sort based on
	 *            the reverse order of the Comparator
	 *** @return The sorted List (in-place)
	 **/
	 ...
	 **/
	public static class NumberComparator<T> implements Comparator<T> {
		...
		public int compare(T o1, T o2) {
			if ((o1 instanceof Number) && (o2 instanceof Number)) {
				// both are Numbers (Number class does not have a "compare"
				// method)
				...
				return (o1 instanceof Number) ? -1 : 1; // numbers sort before
														// non-numbers
			} else {
	...
	/**
	 *** StringComparator class for sorting objects based on their 'toString()'
	 * value
	 **/
	...
	/**
	 *** ReverseOrderComparator class which reserses the sort order of other
	 * Comparators
	 **/
	 ...
	 *            The first index
	 *** @param r
	 *            Random instance used to generate random index
	 **/
